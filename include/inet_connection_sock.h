...
#ifndef _US_INET_CONNECTION_SOCK_H
#define _US_INET_CONNECTION_SOCK_H
...
//				char __user *optval, unsigned int optlen);
//	int	    (*compat_getsockopt)(struct sock *sk,int level, int optname,
//				char __user *optval, int __user *optlen);
//#endif
...
struct inet_connection_sock {
	...
	unsigned long		  icsk_timeout;
 	struct us_timer_list	  icsk_retransmit_timer;
 	struct us_timer_list	  icsk_delack_timer;
	__u32			  icsk_rto;
...
extern void inet_csk_reset_keepalive_timer(struct sock *sk, unsigned long len);
extern struct request_sock *inet_csk_search_req(const struct sock *sk,struct request_sock ***prevp,
					 const __be16 rport, const __be32 raddr,const __be32 laddr);

extern void inet_csk_init_xmit_timers(struct sock *sk, void (*retransmit_handler)(unsigned long),
...
extern struct sock *inet_csk_clone_lock(const struct sock *sk, const struct request_sock *req);
extern void inet_csk_prepare_forced_close(struct sock *sk);
extern s32 inet_timewait_death_row_init(struct inet_hashinfo	*ihash_info_p);
extern void inet_get_local_port_range(struct net* pnet,int *low, int *high);
